...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "77f23652-6e43-49d1-acdb-d87965b4dec2",
  ...
  "service": "gmail",
  "mailUser": "lanegraproduce@gmail.com",
  "mailPassword": "exgxogwwryqogvby",
  "mailContact": "lanegraproduce@gmail.com",
  "mailUserRobert": "roberto.martinez.dev@gmail.com",
  "mailPasswordRobert": "ynznahxboggmcxzx",
  "mailContactRobert": "roberto.martinez.dev@gmail.com"
};
const envOptions = {
  prefix: "NITRO_",
  ...
  es: [
    {
      ...
      load: () => import('../_/es.mjs' /* webpackChunkName: "locale_es_46json_cc96d436" */),
      cache: true
    }
  ],
  en: [
    {
      ...
      load: () => import('../_/en.mjs' /* webpackChunkName: "locale_en_46json_cf710f02" */),
      cache: true
    }
  ],
  val: [
    {
      ...
      load: () => import('../_/val.mjs' /* webpackChunkName: "locale_val_46json_e062a759" */),
      cache: true
    }
  ]
};
...
const pathToI18nConfig = {
  ...
  "/shows/enlasnubes": {
    "es": "/shows/enlasnubes",
    "en": "/shows/enlasnubes",
    "val": "/shows/enlasnubes"
  },
  "/shows/pisarelcesped": {
    "es": "/shows/pisarelcesped",
    "en": "/shows/pisarelcesped",
    "val": "/shows/pisarelcesped"
  },
  "/shows/elarboldetenere": {
    "es": "/shows/elarboldetenere",
    "en": "/shows/elarboldetenere",
    "val": "/shows/elarboldetenere"
  }
};
const i18nPathToPath = {
  ...
  "/shows/nautilus": "/shows/nautilus",
  "/shows/enlasnubes": "/shows/enlasnubes",
  "/shows/pisarelcesped": "/shows/pisarelcesped",
  "/shows/elarboldetenere": "/shows/elarboldetenere"
};
...
const _Hcoc0jHQkpiciwLQYW29fazCTwBO56Iloyz5dPOlbI = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
  ...
  nitro.hooks.hook("render:before", async ({ event }) => {
    ...
    if (!url.pathname.includes("/_i18n/_zCZWjTr") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const plugins = [
  _Hcoc0jHQkpiciwLQYW29fazCTwBO56Iloyz5dPOlbI
];
...
const _skSn4R = _messagesHandlerCached;

const _lazy_lf14ww = () => import('../routes/api/contact.post.mjs');
const _lazy_5T7nuU = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/contact', handler: _lazy_lf14ww, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_5T7nuU, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _skSn4R, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_5T7nuU, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, withTrailingSlash as A, withoutTrailingSlash as B, isScriptProtocol as C, getContext as D, sanitizeStatusCode as E, parsePath as F, defu as G, withLeadingSlash as H, parseURL as I, baseURL as J, createHooks as K, executeAsync as L, toRouteMatcher as M, createRouter$1 as N, getRequestURL as O, getCookie as P, getRequestHeader as Q, klona as R, createDefu as S, isEqual as T, setCookie as U, deleteCookie as V, stringifyQuery as W, isEqual$1 as X, listener as Y, appRootTag as a, buildAssetsURL as b, createError$1 as c, defineEventHandler as d, appRootAttrs as e, appSpaLoaderTag as f, appSpaLoaderAttrs as g, getResponseStatusText as h, getResponseStatus as i, appId as j, defineRenderHandler as k, appTeleportTag as l, appTeleportAttrs as m, getQuery as n, appHead as o, publicAssetsURL as p, destr as q, readBody as r, sendError as s, getRouteRules as t, useRuntimeConfig as u, useNitroApp as v, parseQuery as w, hasProtocol as x, joinURL as y, withQuery as z };
