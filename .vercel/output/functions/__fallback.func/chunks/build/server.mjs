...
import { defineComponent, shallowRef, h, resolveComponent, computed, ref, useAttrs, useTemplateRef, mergeProps, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject, createElementBlock, provide, cloneVNode, defineAsyncComponent, Suspense, Fragment, useSSRContext, createApp, shallowReactive, watch, unref, withCtx, createTextVNode, toDisplayString as toDisplayString$1, createBlock, createCommentVNode, openBlock, createVNode, renderList, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, getCurrentScope, Text } from 'vue';
import { w as parseQuery, x as hasProtocol, y as joinURL, z as withQuery, A as withTrailingSlash, B as withoutTrailingSlash, C as isScriptProtocol, D as getContext, E as sanitizeStatusCode, F as parsePath, G as defu, H as withLeadingSlash, I as parseURL, $ as $fetch$1, J as baseURL, K as createHooks, L as executeAsync, c as createError$1, M as toRouteMatcher, N as createRouter$1, O as getRequestURL, P as getCookie, Q as getRequestHeader, q as destr, R as klona, S as createDefu, T as isEqual, U as setCookie, V as deleteCookie, W as stringifyQuery, X as isEqual$1 } from '../nitro/nitro.mjs';
...
import { ssrRenderAttrs, ssrRenderSlot, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseEqual, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const unhead__SsaMUqF0lYX16ZZR1MCV9dJAIT_reb3TXVt_ku6fSk = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-C0oSGeeu.mjs')
  },
  {
    name: "tour___es",
    path: "/es/tour",
    component: () => import('./tour-DQ_p3y8W.mjs')
  },
  {
    name: "tour___en",
    path: "/en/tour",
  ...
  },
  {
    name: "company___es",
    path: "/es/company",
    component: () => import('./company-BTWHue1G.mjs')
  },
  {
    name: "company___en",
    path: "/en/company",
  ...
  },
  {
    name: "contact___es",
    path: "/es/contact",
    component: () => import('./contact-0Wusq9Ik.mjs')
  },
  {
    name: "contact___en",
    path: "/en/contact",
  ...
  },
  {
    name: "streaming___es",
    path: "/es/streaming",
    component: () => import('./streaming-CLnRkuq-.mjs')
  },
  {
    name: "streaming___en",
    path: "/en/streaming",
  ...
  },
  {
    ...
    component: () => import('./privacy-policy-BvTAaIet.mjs')
  },
  {
  ...
  {
    name: "privacy-policy___val",
    path: "/val/privacy-policy",
    component: () => import('./privacy-policy-BvTAaIet.mjs')
  },
  {
    name: "shows-nautilus___es",
    path: "/es/shows/nautilus",
    component: () => import('./nautilus-uQ94R9IN.mjs')
  },
  {
    name: "shows-nautilus___en",
    path: "/en/shows/nautilus",
    component: () => import('./nautilus-uQ94R9IN.mjs')
  },
  {
    name: "shows-nautilus___val",
    path: "/val/shows/nautilus",
    component: () => import('./nautilus-uQ94R9IN.mjs')
  },
  {
    name: "shows-enlasnubes___es",
    path: "/es/shows/enlasnubes",
    component: () => import('./enlasnubes-BGxb6nKq.mjs')
  },
  {
    name: "shows-enlasnubes___en",
    path: "/en/shows/enlasnubes",
    component: () => import('./enlasnubes-BGxb6nKq.mjs')
  },
  {
    name: "shows-enlasnubes___val",
    path: "/val/shows/enlasnubes",
    component: () => import('./enlasnubes-BGxb6nKq.mjs')
  },
  {
    name: "shows-pisarelcesped___es",
    path: "/es/shows/pisarelcesped",
    component: () => import('./pisarelcesped-CXce-nH7.mjs')
  },
  {
    name: "shows-pisarelcesped___en",
    path: "/en/shows/pisarelcesped",
    component: () => import('./pisarelcesped-CXce-nH7.mjs')
  },
  {
    name: "shows-pisarelcesped___val",
    path: "/val/shows/pisarelcesped",
    component: () => import('./pisarelcesped-CXce-nH7.mjs')
  },
  {
    name: "shows-elarboldetenere___es",
    path: "/es/shows/elarboldetenere",
    component: () => import('./elarboldetenere-kszRBfQK.mjs')
  },
  {
    name: "shows-elarboldetenere___en",
    path: "/en/shows/elarboldetenere",
    component: () => import('./elarboldetenere-kszRBfQK.mjs')
  },
  {
    name: "shows-elarboldetenere___val",
    path: "/val/shows/elarboldetenere",
    component: () => import('./elarboldetenere-kszRBfQK.mjs')
  }
];
...
const revive_payload_server_7V9ufnm_GH1UXdhAlLnUcfnMAsRcGPMpXc36al2Fwgc = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyNuxtIcon = defineAsyncComponent(() => import('./nuxt-icon-BnvAcADI.mjs').then((r) => r["default"] || r.default || r));
...
const localeLoaders = {
  es: [
    {
      key: "locale_es_46json_cc96d436",
      load: () => import(
        './es-DzrGJVgO.mjs'
        /* webpackChunkName: "locale_es_46json_cc96d436" */
      ),
      cache: true
    }
  ],
  en: [
    {
      key: "locale_en_46json_cf710f02",
      load: () => import(
        './en-ClQcScji.mjs'
        /* webpackChunkName: "locale_en_46json_cf710f02" */
      ),
      cache: true
    }
  ],
  val: [
    {
      key: "locale_val_46json_e062a759",
      load: () => import(
        './val-KqMCk1rt.mjs'
        /* webpackChunkName: "locale_val_46json_e062a759" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/_zCZWjTr"}/${locale}/messages.json`, { headers });
...
const switch_locale_path_ssr_TWJUlrM6mKpSKDw6TCq1tL_xlsAOuLRRqBLi3thFYYU = /* @__PURE__ */ defineNuxtPlugin({
...
const route_locale_detect_7aKZfCWvNbEDhecuC9MDkDt3e2j6NZ5UvW177wwvtc4 = /* @__PURE__ */ defineNuxtPlugin({
...
const preload_LZLegsSjQtf58wDF0T5aaFwW_MiGt_cZMDQTy_jOjts = /* @__PURE__ */ defineNuxtPlugin({
...
const i18n_zVJxjrwQ3E7TWOFPnk87cOiFWHQ6iWCvySvMxOIxr9s = /* @__PURE__ */ defineNuxtPlugin({
  name: "i18n:plugin",
  parallel: false,
  async setup(_nuxt) {
    let __temp, __restore;
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/_zCZWjTr"}/${locale}/messages.json`));
...
const ssg_detect__RPzx8c7zVaJFqMNmP0kAZCnmyczFfOLydvhXj122qg = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  payloadPlugin,
  unhead__SsaMUqF0lYX16ZZR1MCV9dJAIT_reb3TXVt_ku6fSk,
  plugin$1,
  revive_payload_server_7V9ufnm_GH1UXdhAlLnUcfnMAsRcGPMpXc36al2Fwgc,
  plugin,
  components_plugin_4kY4pyzJIYX99vmMAAIorFf3CnAaptHitJgf7JxiED8,
  switch_locale_path_ssr_TWJUlrM6mKpSKDw6TCq1tL_xlsAOuLRRqBLi3thFYYU,
  route_locale_detect_7aKZfCWvNbEDhecuC9MDkDt3e2j6NZ5UvW177wwvtc4,
  preload_LZLegsSjQtf58wDF0T5aaFwW_MiGt_cZMDQTy_jOjts,
  i18n_zVJxjrwQ3E7TWOFPnk87cOiFWHQ6iWCvySvMxOIxr9s,
  ssg_detect__RPzx8c7zVaJFqMNmP0kAZCnmyczFfOLydvhXj122qg
];
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (props.isVisible) {
        _push(`<div${ssrRenderAttrs(mergeProps({
          class: `base-toast ${props.severity}`
        }, _attrs))} data-v-11a00cc7><span class="base-toast-message" data-v-11a00cc7>${ssrInterpolate(props.message)}</span></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
_sfc_main$9.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../components/UI/base-toast/BaseToast.vue");
  return _sfc_setup$9 ? _sfc_setup$9(props, ctx) : void 0;
};
const BaseToast = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-11a00cc7"]]);
...
const vercelRuntime$Kqab8iZmLEqUq3roNgG5o_KqKoRaRqoqghb4DfNVnIY = defineProvider({
  validateDomains: true,
  getImage: (src, { modifiers, baseURL: baseURL2 = "/_vercel/image" }, ctx) => {
...
const imageOptions = {
  ...
  provider: "vercel",
  providers: {
    ["vercel"]: { setup: vercelRuntime$Kqab8iZmLEqUq3roNgG5o_KqKoRaRqoqghb4DfNVnIY, defaults: {} }
  }
};
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+image@2.0.0_db0@0.3.4_ioredis@5.8.2_magicast@0.5.1/node_modules/@nuxt/image/dist/runtime/components/NuxtImg.vue");
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const toggleAccordion = (callback) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "base-accordion-container" }, _attrs))} data-v-fb8c6723><div class="base-accordion-header" data-v-fb8c6723>`);
      ...
      _push(`</div>`);
      if (isOpen.value) {
        _push(`<div class="base-accordion-content" data-v-fb8c6723>`);
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../components/UI/base-accordion/BaseAccordion.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const BaseAccordion = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-fb8c6723"]]);
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  __name: "BaseSwitchTheme",
  __ssrInlineRender: true,
  setup(__props) {
    useThemeStore();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "switch-container" }, _attrs))} data-v-1665fe06><label class="switch" data-v-1665fe06><input type="checkbox" data-v-1665fe06><div class="slider round" data-v-1665fe06></div></label></div>`);
    };
  }
});
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../components/UI/base-switch-theme/BaseSwitchTheme.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const BaseSwitchTheme = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-1665fe06"]]);
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<form${ssrRenderAttrs(mergeProps({ class: "select-locale-wrapped" }, _attrs))} data-v-5a7f37a8><!--[-->`);
      ssrRenderList(unref(locales), (l) => {
        _push(`<label data-v-5a7f37a8><input${ssrIncludeBooleanAttr(ssrLooseEqual(currentLocale.value, l.code)) ? " checked" : ""} type="radio"${ssrRenderAttr("value", l.code)} data-v-5a7f37a8><span data-v-5a7f37a8>${ssrInterpolate(l.code.toUpperCase())}</span></label>`);
      });
      _push(`<!--]--></form>`);
    };
  }
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../components/UI/base-locale/BaseLocale.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const BaseLocale = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-5a7f37a8"]]);
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-65925ff5>`);
      _push(ssrRenderComponent(BaseAccordion, null, {
        header: withCtx(({ isOpen, toggleAccordion }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<header class="header-container" data-v-65925ff5${_scopeId}><div class="header-logo-wrapped" data-v-65925ff5${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtImg, {
              src: unref(store).getCurrentTheme === "light" ? "/logo-black.png" : "/logo-white.png",
              preset: "lanegra",
              alt: "Logo de la compañía",
              class: "lanegra",
              loading: "eager",
              decoding: "async",
              onClick: closeDropdownMenuShowsAndGoHome
            }, null, _parent2, _scopeId));
            _push2(`</div><nav class="navs-desktop-wrapped" data-v-65925ff5${_scopeId}><!--[-->`);
            ssrRenderList(ROUTER_LIST_ITEMS, (item) => {
              _push2(ssrRenderComponent(_component_NuxtLink, {
                key: item.to,
                class: "link-item",
                to: unref(localePath2)(item.to),
                onClick: closeDropdownMenuShows
              }, {
                default: withCtx((_, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(_ctx.$t(item.text))}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString$1(_ctx.$t(item.text)), 1)
                    ];
                  }
                }),
                _: 2
            ...
            _push2(`<!--]--><nav class="dropdown" data-v-65925ff5${_scopeId}><a class="link-item" data-v-65925ff5${_scopeId}>${ssrInterpolate(_ctx.$t("app.shows.title"))}</a>`);
            if (hasShowsItems.value) {
              _push2(`<div class="dropdown-menu" data-v-65925ff5${_scopeId}><!--[-->`);
              ssrRenderList(ROUTER_SHOWS_LIST_ITEMS, (item) => {
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  key: item.to,
                  class: "link-item",
                  to: unref(localePath2)(item.to),
            ...
            _push2(`</nav></nav><div class="header-menu-wrapped" data-v-65925ff5${_scopeId}>`);
            _push2(ssrRenderComponent(BaseLocale, null, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(BaseSwitchTheme, null, null, _parent2, _scopeId));
            _push2(`<div class="header-menu-item" data-v-65925ff5${_scopeId}>`);
            if (!isOpen) {
            ...
            return [
              createVNode("header", { class: "header-container" }, [
                createVNode("div", { class: "header-logo-wrapped" }, [
                ...
                createVNode("nav", { class: "navs-desktop-wrapped" }, [
                  (openBlock(), createBlock(Fragment, null, renderList(ROUTER_LIST_ITEMS, (item) => {
                  ...
                  createVNode("nav", {
                    class: "dropdown",
                    onMouseenter: openDropdownMenuShows
                  }, [
                    createVNode("a", { class: "link-item" }, toDisplayString$1(_ctx.$t("app.shows.title")), 1),
                    hasShowsItems.value ? (openBlock(), createBlock("div", {
                      key: 0,
                      class: "dropdown-menu",
                      onMouseleave: closeDropdownMenuShows
                    }, [
                      (openBlock(), createBlock(Fragment, null, renderList(ROUTER_SHOWS_LIST_ITEMS, (item) => {
                        return createVNode(_component_NuxtLink, {
                          key: item.to,
                          class: "link-item",
                          to: unref(localePath2)(item.to),
                ...
                createVNode("div", { class: "header-menu-wrapped" }, [
                  createVNode(BaseLocale),
                  createVNode(BaseSwitchTheme),
                  createVNode("div", { class: "header-menu-item" }, [
                    !isOpen ? (openBlock(), createBlock(unref(Icon), {
                      key: 0,
                      class: "icon-item",
                      icon: "fa6-solid:bars",
                      width: "20",
        ...
        content: withCtx(({ isOpen, close }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (isOpen) {
              _push2(`<nav class="nav-menu-wrapped" data-v-65925ff5${_scopeId}><!--[-->`);
              ssrRenderList(ROUTER_LIST_ITEMS, (item) => {
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  key: item.to,
                  class: "link-item",
              ...
              _push2(`<!--]--><div class="nav-shows-wrapped" data-v-65925ff5${_scopeId}><a class="link-item" data-v-65925ff5${_scopeId}>${ssrInterpolate(_ctx.$t("app.shows.title"))}</a>`);
              _push2(ssrRenderComponent(unref(Icon), {
                class: "icon-item",
                icon: "fa6-solid:chevron-down",
                inline: true,
                "vertical-flip": hasShowsItems.value
              }, null, _parent2, _scopeId));
              _push2(`</div>`);
              if (hasShowsItems.value) {
                _push2(`<div class="nav-menu-wrapped" data-v-65925ff5${_scopeId}><!--[-->`);
                ssrRenderList(ROUTER_SHOWS_LIST_ITEMS, (item) => {
                  _push2(ssrRenderComponent(_component_NuxtLink, {
                    key: item.to,
                    class: "link-item",
            ...
            return [
              isOpen ? (openBlock(), createBlock("nav", {
                key: 0,
                class: "nav-menu-wrapped"
              }, [
                (openBlock(), createBlock(Fragment, null, renderList(ROUTER_LIST_ITEMS, (item) => {
                  return createVNode(_component_NuxtLink, {
                    key: item.to,
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layouts/TheHeader.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const TheHeader = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-65925ff5"]]);
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtImg = __nuxt_component_0;
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "footer-wrapped" }, _attrs))} data-v-4b49a136><div class="logo-ivc-container" data-v-4b49a136>`);
      ...
      _push(`<p class="ivc-text" data-v-4b49a136> L&#39;entitat Institut Valencià de Cultura (IVC) ha concedit una ajuda de 64.441,54€ a La Negra Produce SL per a la realització de les seues produccions teatrals de l&#39;any 2025, així com la gira dels seus espectacles anteriors, projectes de residència i activitats de mediació. Tot això de conformitat amb el que és preveu en l’article 4 de la Llei 1/2022, de 13 d’abril, de la Generalitat, de transparència i bon govern (DOGV 9323, 22.04.2022). </p></div><div class="logos-container" data-v-4b49a136><!--[-->`);
      ...
      _push(`<!--]--></div><div class="social-media-container" data-v-4b49a136><a href="https://www.facebook.com/lanegraproduce/" target="_blank" rel="noopener noreferrer" data-v-4b49a136>`);
      _push(ssrRenderComponent(unref(Icon), {
        class: "icon-item",
        icon: "entypo-social:facebook",
        inline: true
      }, null, _parent));
      _push(`</a><a href="https://www.instagram.com/lanegra_teatre" target="_blank" rel="noopener noreferrer" data-v-4b49a136>`);
      _push(ssrRenderComponent(unref(Icon), {
        class: "icon-item",
        icon: "fe:instagram",
        inline: true
      }, null, _parent));
      _push(`</a><a href="https://www.twitch.tv/lanegrateatro" target="_blank" rel="noopener noreferrer" data-v-4b49a136>`);
      _push(ssrRenderComponent(unref(Icon), {
        class: "icon-item",
        icon: "ion:logo-twitch",
        inline: true
      }, null, _parent));
      _push(`</a><a href="https://open.spotify.com" target="_blank" rel="noopener noreferrer" data-v-4b49a136>`);
      _push(ssrRenderComponent(unref(Icon), {
        class: "icon-item",
        icon: "cib:spotify",
        inline: true
      }, null, _parent));
      _push(`</a><span data-v-4b49a136> | </span><a class="contact" href="mailto:lanegraproduce@gmail.com" data-v-4b49a136> lanegraproduce@gmail.com </a></div><p class="copy" data-v-4b49a136>© ${ssrInterpolate(unref(currentYear))} Carlos Amador Aparicio</p></footer>`);
    };
  }
});
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../layouts/TheFooter.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const TheFooter = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-4b49a136"]]);
function useTheme() {
  useThemeStore();
}
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(BaseToast, {
        "is-visible": unref(store)?.success,
        severity: "success",
        message: _ctx.$t("app.contact.emailOk")
      }, null, _parent));
      _push(ssrRenderComponent(BaseToast, {
        "is-visible": unref(store)?.error,
        severity: "error",
        message: _ctx.$t("app.contact.emailError")
      }, null, _parent));
      _push(`<main class="app-main-container">`);
      _push(ssrRenderComponent(TheHeader, { class: "app-header-container" }, null, _parent));
      _push(ssrRenderComponent(_component_NuxtPage, { class: "app-content-container" }, null, _parent));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DkADrBCo.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BBE32tG_.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.2.2_@parcel+watcher@2.5.1_@types+node@25.0.0_@vue+compiler-sfc@3.5.25_cac@6.7.14_e9a18340399df0f60ac723f1bb01ae94/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.2.2_@parcel+watcher@2.5.1_@types+node@25.0.0_@vue+compiler-sfc@3.5.25_cac@6.7.14_e9a18340399df0f60ac723f1bb01ae94/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, __nuxt_component_0$2 as a, useNavigation as b, __nuxt_component_0 as c, useLocalePath as d, entry_default as default, useToastStore as e, useLocaleStore as f, useHead as u };
